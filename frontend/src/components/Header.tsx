...
function Header({
  ...
  return (
    <header
      className={`sticky top-0 z-50 mt-0.5 w-full border border-[color:var(--line-soft)] bg-[color:var(--surface-panel-strong)]/50 shadow-[0_10px_24px_rgba(0,0,0,0.12)] backdrop-blur-md transition-all duration-200 ${
